    ...
    toList([
      new Question(
        ...
        toList([
          ...
          new Answer("Answer Three", false),
          new Answer("Answer Four", false)
        ])
      ),
      new Question(
        2,
...
function view(model) {
  return div(
    toList([]),
    toList([
      h1(toList([]), toList([text2(model.title)])),
      div(
        toList([]),
        map(
          model.questions,
